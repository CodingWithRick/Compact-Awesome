...
local globalKeys =
  ...
  awful.key(
    ...
    'r',
    function()
      awful.spawn("dmenu_run -p Run: -i -nb '#192832' -nf '#fefffe' -sb '#fefffe' -sf '#191919' -fn 'FiraMono:pixelsize=22'")
    end,
  ...
  awful.key(
    ...
    'space',
    function()
      awful.spawn("dmenu_run -i -nb '#192832' -nf '#fefffe' -sb '#fefffe' -sf '#191919' -fn 'FiraMono:pixelsize=22'")
    end,
